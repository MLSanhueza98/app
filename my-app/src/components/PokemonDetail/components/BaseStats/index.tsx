                    ...
                    <div key={name} className={styles.item}>
                        ...
                        <div className={styles.rigth}>
                            ...
                            <div className={styles.line}>
                                <div className={styles.background} style={{background: backgroundSelected}} />
                                <div className={styles.secondLine} style={{background:backgroundSelected, opacity: "1", width: `${(base_stat / maxStat) * 100}%`,}}/>
                            </div>
                        </div>
                    </div>
                )
